...
const getManagementToken = () => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const res = yield axios_1.default.post(`https://${process.env.AUTH0_DOMAIN}/oauth/token`, {
        ...
        console.error("Failed to get management token", ((_a = err.response) === null || _a === void 0 ? void 0 : _a.data) || err.message);
